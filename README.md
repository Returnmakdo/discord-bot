...
- 🎨 **예쁜 임베드**: 카테고리별 색상과 이모지로 시각화
- 💾 **중복 방지**: SQLite DB로 이미 알린 공지 필터링
- 🔁 **재시도 로직**: 넥슨 서버 불안정 시 자동 재시도
- 📝 **상세 로깅**: 모든 작업 기록 및 에러 추적
...
CHANNEL_ID_MAINTENANCE=점검_전용_채널_ID
CHANNEL_ID_EVENT=이벤트_전용_채널_ID
